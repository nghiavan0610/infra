...
#
# Examples:
#   ./lib/db-cli.sh postgres create-user app_user secret123 myapp
#   ./lib/db-cli.sh mysql create-user app_user secret123 myapp
#   ./lib/db-cli.sh mongo create-user app_user secret123 myapp
#   ./lib/db-cli.sh postgres delete-user app_user --drop-schema
